...
Plugins need to be packaged as Python libraries \(distributed on PyPI separate from MkDocs\) and each must register as a Plugin via a setuptools entry\_point. Add the following to your `setup.py` script:
